...
export function SingleDataExtractorClient() {
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold font-headline">Single Document Extractor</h1>
          ...
          <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    {processedData && (
                        <DataExtractorResults processedData={processedData} fileName={file?.name || 'document'} />
                    )}
                </div>
              </div>
          </div>
