        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
             ...
             <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                        <Label htmlFor="finance-module" className="text-base">Finance Module</Label>
                        <p className="text-sm text-muted-foreground">
                            Manage all financial transactions and accounts.
                        </p>
                    </div>
                </div>
                <Switch
            ...
            <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                        <Label htmlFor="vendor-module" className="text-base">Vendor / Supplier Module</Label>
                        <p className="text-sm text-muted-foreground">
                            Manage vendors, suppliers, and their bills.
                        </p>
                    </div>
                </div>
                <Switch
            ...
            <div className="flex items-center justify-between rounded-lg border p-4">
             ...
             <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                        <Label htmlFor="workflow-module" className="text-base">Workflow Module</Label>
                        <p className="text-sm text-muted-foreground">
             ...
             <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                        <Label htmlFor="data-processing-module" className="text-base">Data Processing Module</Label>
                        <p className="text-sm text-muted-foreground">
