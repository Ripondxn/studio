...
!function(e, t) {
    ...
    return function() {
                                ...
                                try {
                                    ...
                                    i({
                                        messages: [
                                            ...
                                            n,
                                            "Original error: ".concat(a(e).message)
                                        ],
                                        level: "warning"
                                    });
                                }
                                e.setAttribute("id", "react-to-print-".concat(o)), S && e.setAttribute("nonce", S), e.appendChild(x.createTextNode(r)), x.head.appendChild(e);
                            }
        ...
        function f(param) {
            let { bodyClass: e, contentRef: t, copyShadowRoots: o, documentTitle: n, fonts: r, ignoreGlobalStyles: d, nonce: u, onAfterPrint: p, onBeforePrint: f, onPrintError: g, pageStyle: m, preserveAfterPrint: b, print: y, suppressErrors: v } = param;
            return (0, s.useCallback)((s)=>{
                function w() {
                    const l = {
                        ...
                        return e.width = "".concat(document.documentElement.clientWidth, "px"), e.height = "".concat(document.documentElement.clientHeight, "px"), e.style.position = "absolute", e.style.top = "-".concat(document.documentElement.clientHeight + 100, "px"), e.style.left = "-".concat(document.documentElement.clientWidth + 100, "px"), e.id = "printWindow", e.srcdoc = "<!DOCTYPE html>", e;
                    }(), w = function(e, t) {
                        const { contentRef: o, fonts: n, ignoreGlobalStyles: r, suppressErrors: s } = t, l = function(param) {
...
//# sourceMappingURL=node_modules_cd5dc10f._.js.map