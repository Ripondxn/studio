...
/* __next_internal_action_entry_do_not_use__ [{"00831fee985f82fbb15a66fe64cff566d6c6f2867b":"getAllTenants","400726e3bdf468c8f88bbdb9aaa36ab5f223b4fb88":"deleteTenantData","403c44f137a3ca19d2679727ba3eaf54e85a4e3dd6":"findTenantData","40c7c6f727d1176bc496bfd420805a4dd89df95ec4":"cancelSubscription","6036964a174b54674356664e3bee36f62e4123d1df":"saveSubscriptionSettings","70d98d48fadc7e403939dd6b646483c6ffbf3102b8":"saveTenantData"},"",""] */ __turbopack_context__.s([
    "cancelSubscription",
    ()=>cancelSubscription,
    "deleteTenantData",
    ()=>deleteTenantData,
...
async function getTenants() {
    const tenantsCollection = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants');
...
async function getInvoices() {
    const invoicesCollection = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('invoices');
...
async function getAllTenants() {
    ...
    const contractsByTenantCode = new Map();
    ...
    for (const invoice of invoices){
        if (invoice.status !== 'Cancelled') {
            if (!invoiceStatsByCustomer.has(invoice.customerCode)) {
                invoiceStatsByCustomer.set(invoice.customerCode, {
                    totalBilled: 0,
                    totalPaid: 0
                });
            }
    ...
    return tenants.filter((l)=>l.tenantData && l.tenantData.code).map((l)=>{
        ...
        if (l.tenantData.isSubscriptionActive) {
            const stats = invoiceStatsByCustomer.get(tenantCode) || {
                totalBilled: 0,
                totalPaid: 0
            };
...
async function saveTenantData(dataToSave, isNewRecord, isAutoCode) {
    try {
        ...
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants').doc(tenantCode);
        const dataForDb = {
            tenantData,
            attachments
        };
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/tenants');
        return {
            success: true,
            data: dataForDb
        };
...
async function findTenantData(tenantCode) {
    try {
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants').doc(tenantCode);
...
async function deleteTenantData(tenantCode) {
    try {
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants').doc(tenantCode);
        await docRef.delete();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/tenants');
...
async function cancelSubscription(tenantCode) {
    try {
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants').doc(tenantCode);
        await docRef.update({
            'tenantData.isSubscriptionActive': false
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/tenants');
        return {
            success: true
...
async function saveSubscriptionSettings(tenantCode, settings) {
    try {
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection('tenants').doc(tenantCode);
        await docRef.update({
            'tenantData.subscription': settings
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/tenants');
        return {
            success: true
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getAllTenants, "00831fee985f82fbb15a66fe64cff566d6c6f2867b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveTenantData, "70d98d48fadc7e403939dd6b646483c6ffbf3102b8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(findTenantData, "403c44f137a3ca19d2679727ba3eaf54e85a4e3dd6", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteTenantData, "400726e3bdf468c8f88bbdb9aaa36ab5f223b4fb88", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(cancelSubscription, "40c7c6f727d1176bc496bfd420805a4dd89df95ec4", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveSubscriptionSettings, "6036964a174b54674356664e3bee36f62e4123d1df", null);
}),
...
"[project]/src/app/admin/contract-continuity/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"0058c26caef1ffa252ed3d0b4904737c8e4fe91b30":"getVacantPeriods","006fcb15c795a34b56c2800406e1d4864bf75843f7":"getMovementHistory","00855cfa2af8cc3be18ec8e3fa781494bf06e9010a":"getProblematicContracts"},"",""] */ __turbopack_context__.s([
    "getMovementHistory",
    ()=>getMovementHistory,
...
async function getProblematicContracts() {
    ...
    const contractsWithStatus = sortedContracts.map((contract, index)=>{
        ...
        if (previousContract && previousContract.tenantCode === contract.tenantCode && previousContract.property === contract.property && previousContract.unitCode === contract.unitCode && previousContract.roomCode === contract.roomCode) {
            const prevEndDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(previousContract.endDate);
            const currentStartDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(contract.startDate);
            const daysBetween = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["differenceInDays"])(currentStartDate, prevEndDate);
            if (daysBetween > 1) {
                periodStatus = 'Gap';
    ...
    return contractsWithStatus.filter((c)=>c.periodStatus === 'Overlap' || c.periodStatus === 'Gap');
}
async function getMovementHistory() {
    const allContracts = await readContracts();
    const allMovements = [];
    allContracts.forEach((contract)=>{
        const movements = contract.paymentSchedule.filter((item)=>item.chequeNo === 'MOVEMENT').map((item, index, arr)=>{
            const previousMovements = arr.slice(0, index);
            const lastMoveDate = previousMovements.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(previousMovements[previousMovements.length - 1].dueDate) : null;
            const startDateOfStay = lastMoveDate || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(contract.startDate);
            const moveOutDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(item.dueDate);
            const daysStayed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["differenceInDays"])(moveOutDate, startDateOfStay);
            return {
                date: item.dueDate,
...
async function getVacantPeriods() {
    const contracts = await readContracts();
    const vacantPeriods = [];
    const contractsByUnit = new Map();
    ...
    contractsByUnit.forEach((unitContracts, key)=>{
        ...
        for(let i = 0; i < sorted.length - 1; i++){
            ...
            const vacancyStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(prevContract.endDate), 1);
            const vacancyEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(nextContract.startDate), -1);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isBefore"])(vacancyStart, vacancyEnd) || vacancyStart.getTime() === vacancyEnd.getTime()) {
                const daysVacant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["differenceInDays"])(vacancyEnd, vacancyStart) + 1;
                vacantPeriods.push({
                    id: `${key}-${i}`,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getProblematicContracts, "00855cfa2af8cc3be18ec8e3fa781494bf06e9010a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getMovementHistory, "006fcb15c795a34b56c2800406e1d4864bf75843f7", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getVacantPeriods, "0058c26caef1ffa252ed3d0b4904737c8e4fe91b30", null);
}),
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/src/app/property/units/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/src/app/tenancy/tenants/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/src/app/finance/banking/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/src/app/admin/contract-continuity/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/src/app/finance/cheque-deposit/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/src/app/property/rooms/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE11 => \"[project]/src/app/admin/workflow-settings/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE12 => \"[project]/src/app/workflow/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$property$2f$units$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/property/units/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/tenants/actions.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$contract$2d$continuity$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/contract-continuity/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$cheque$2d$deposit$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/finance/cheque-deposit/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$property$2f$rooms$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/property/rooms/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$workflow$2d$settings$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/workflow-settings/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$workflow$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/workflow/actions.ts [app-rsc] (ecmascript)");
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/src/app/property/units/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/src/app/tenancy/tenants/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/src/app/finance/banking/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/src/app/admin/contract-continuity/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/src/app/finance/cheque-deposit/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/src/app/property/rooms/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE11 => \"[project]/src/app/admin/workflow-settings/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE12 => \"[project]/src/app/workflow/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "0058c26caef1ffa252ed3d0b4904737c8e4fe91b30",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$contract$2d$continuity$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getVacantPeriods"],
    ...
    "006fcb15c795a34b56c2800406e1d4864bf75843f7",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$contract$2d$continuity$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMovementHistory"],
    ...
    "00831fee985f82fbb15a66fe64cff566d6c6f2867b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllTenants"],
    "00855cfa2af8cc3be18ec8e3fa781494bf06e9010a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$contract$2d$continuity$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProblematicContracts"],
    ...
    "00d3d1c13e5b326b206ba4708cc47f513877954c3a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllTransactions"],
    "00d765bad3197e297469ba1a64a90e8c966c0e3713",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["readPettyCash"],
    ...
    "400726e3bdf468c8f88bbdb9aaa36ab5f223b4fb88",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteTenantData"],
    ...
    "400c481d00070cb57c56ac30b3016042b9ac563f1e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTransactionsForAccount"],
    ...
    "401e9906d804110d526195abaac1f1177eb290cee2",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["writePettyCash"],
    ...
    "403c44f137a3ca19d2679727ba3eaf54e85a4e3dd6",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findTenantData"],
    ...
    "40c681baaa6ac4134faf54796bcecb422ad060e160",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["transferFunds"],
    ...
    "40c7c6f727d1176bc496bfd420805a4dd89df95ec4",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cancelSubscription"],
    ...
    "40eadf85ff8bd172b35e07036c54b6a9cf4a6ae9cb",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteBankAccount"],
    ...
    "6036964a174b54674356664e3bee36f62e4123d1df",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveSubscriptionSettings"],
    "606ba51a1c7455d0fac84142011d1e63ca94ea5790",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveBankAccount"],
    ...
    "70d98d48fadc7e403939dd6b646483c6ffbf3102b8",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveTenantData"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$app$2f$tenancy$2f$contract$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE5__$3d3e$__$225b$project$5d2f$src$2f$app$2f$property$2f$units$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE6__$3d3e$__$225b$project$5d2f$src$2f$app$2f$tenancy$2f$tenants$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE7__$3d3e$__$225b$project$5d2f$src$2f$app$2f$finance$2f$banking$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE8__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$contract$2d$continuity$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE9__$3d3e$__$225b$project$5d2f$src$2f$app$2f$finance$2f$cheque$2d$deposit$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE10__$3d3e$__$225b$project$5d2f$src$2f$app$2f$property$2f$rooms$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE11__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$workflow$2d$settings$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE12__$3d3e$__$225b$project$5d2f$src$2f$app$2f$workflow$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/lib/license.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE5 => "[project]/src/app/property/units/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE6 => "[project]/src/app/tenancy/tenants/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE7 => "[project]/src/app/finance/banking/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE8 => "[project]/src/app/admin/contract-continuity/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE9 => "[project]/src/app/finance/cheque-deposit/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE10 => "[project]/src/app/property/rooms/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE11 => "[project]/src/app/admin/workflow-settings/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE12 => "[project]/src/app/workflow/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/license.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)");
...
"[project]/src/app/dashboard-client.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/dashboard-client.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/dashboard-client.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/app/dashboard-client.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
function getDashboardData(contracts, allUnits, tenants, allProperties, allRooms, allLeaseContracts) {
    ...
    const vacantUnitsCount = allUnits.filter((unit)=>unit.unitStatus === 'Active' && !occupiedUnitCodes.has(unit.unitCode) && allRooms.every((r)=>r.unitCode !== unit.unitCode)).length;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6e16abb._.js.map