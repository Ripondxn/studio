...
"[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"007d4719820e46ced55256390448c5aee68be4e842":"getAllCustomers","4002fd57e75cff956a6518f8fd1d8f3cb8adaf4cf6":"getPaymentsForCustomer","405c23beb388ab81ff4b20aa060cbb61030bc9f7e3":"deleteCustomerData","4068bf71fb24fb566ff4884c72c3869fa64b134e29":"findCustomerData","70d635ffd3717bdb51b79c8460b5150641d566b373":"saveCustomerData"},"",""] */ __turbopack_context__.s([
    "deleteCustomerData",
    ()=>deleteCustomerData,
    "findCustomerData",
    ()=>findCustomerData,
...
async function getNextCustomerCode() {
    const querySnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").get();
    let maxNum = 0;
...
async function saveCustomerData(dataToSave, isNewRecord, isAutoCode) {
    try {
        ...
        if (isNewRecord) {
            ...
            const querySnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").where("customerData.code", "==", code).get();
            if (!querySnapshot.empty) {
                return {
                    success: false,
                    error: `Customer with code "${code}" already exists.`
                };
            }
            const docRef = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").add(dataToSave);
            savedCustomer = {
                ...dataToSave,
                id: docRef.id
            };
            ...
            if (!querySnapshot.empty) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").doc(docId).update(dataToSave);
                savedCustomer = {
                    ...dataToSave,
                    id: docId
                };
                ...
                return {
                    success: false,
                    error: `Customer with code "${code}" not found.`
                };
            }
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/customer');
        return {
            success: true,
            data: savedCustomer.customerData
        };
    } catch (error) {
...
async function findCustomerData(customerCode) {
    try {
        if (customerCode === 'new') {
        ...
        const querySnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").where("customerData.code", "==", customerCode).get();
        if (!querySnapshot.empty) {
...
async function deleteCustomerData(customerCode) {
    try {
        const querySnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").where("customerData.code", "==", customerCode).get();
        if (querySnapshot.empty) {
            return {
        ...
        const docId = querySnapshot.docs[0].id;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("customers").doc(docId).delete();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/tenancy/customer');
        return {
            success: true
        };
...
async function getPaymentsForCustomer(customerCode) {
    try {
        const querySnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$admin$2d$config$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["firestoreAdmin"].collection("payments").where("partyName", "==", customerCode).where("type", "==", "Receipt").get();
        const customerPayments = querySnapshot.docs.map((doc)=>doc.data());
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getAllCustomers, "007d4719820e46ced55256390448c5aee68be4e842", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveCustomerData, "70d635ffd3717bdb51b79c8460b5150641d566b373", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(findCustomerData, "4068bf71fb24fb566ff4884c72c3869fa64b134e29", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteCustomerData, "405c23beb388ab81ff4b20aa060cbb61030bc9f7e3", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPaymentsForCustomer, "4002fd57e75cff956a6518f8fd1d8f3cb8adaf4cf6", null);
}),
"[project]/.next-internal/server/app/tenancy/customer/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/tenancy/customer/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "007d4719820e46ced55256390448c5aee68be4e842",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllCustomers"],
    ...
    "4002fd57e75cff956a6518f8fd1d8f3cb8adaf4cf6",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPaymentsForCustomer"],
    "405c23beb388ab81ff4b20aa060cbb61030bc9f7e3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteCustomerData"],
    "4068bf71fb24fb566ff4884c72c3869fa64b134e29",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findCustomerData"],
    ...
    "70d635ffd3717bdb51b79c8460b5150641d566b373",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveCustomerData"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$tenancy$2f$customer$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/tenancy/customer/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/lib/license.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/license.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)");
...
"[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const CustomerContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call CustomerContent() from the server but CustomerContent is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/tenancy/customer/customer-content.tsx <module evaluation>", "CustomerContent");
}),
"[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const CustomerContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call CustomerContent() from the server but CustomerContent is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/tenancy/customer/customer-content.tsx", "CustomerContent");
}),
"[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$customer$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$customer$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$customer$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/app/tenancy/customer/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$customer$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/customer-content.tsx [app-rsc] (ecmascript)");
;
;
;
;
...
async function CustomersPage() {
    const customers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllCustomers"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                fileName: "[project]/src/app/tenancy/customer/page.tsx",
                                lineNumber: 17,
                                columnNumber: 13
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-muted-foreground",
                                children: "Manage customer profiles and interactions."
                            }, void 0, false, {
                                fileName: "[project]/src/app/tenancy/customer/page.tsx",
                                lineNumber: 18,
                                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$customer$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CustomerContent"], {
                customers: customers
            }, void 0, false, {
                fileName: "[project]/src/app/tenancy/customer/page.tsx",
                lineNumber: 26,
...
"[project]/src/app/tenancy/customer/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/tenancy/customer/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bdbb1e78._.js.map