...
"[project]/src/app/finance/due-payments/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00f5bec3b7d6871d6a6a74ef3c1a0c9d5c344fcfe9":"getDuePayments","400a999ba599a0f01e1fe8829d5603350d5f9ce9a9":"deleteDuePaymentInstallment","40b728a3e12571d9a7517418be6c007897bec6720e":"getSummary"},"",""] */ __turbopack_context__.s([
...
async function getDuePayments() {
    ...
    const payments = await readData(paymentsFilePath);
    const landlords = await readData(landlordsFilePath);
    const landlordMap = new Map(landlords.map((l)=>[
            l.landlordData.code,
            l.landlordData.name
        ]));
    const paidInstallments = new Set(payments.filter((p)=>p.referenceNo && p.status !== 'Cancelled').map((p)=>p.referenceNo));
    ...
    tenancyContracts.forEach((contract)=>{
        ...
        contract.paymentSchedule.forEach((installment)=>{
            ...
            const dueDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseISO"])(installment.dueDate);
            let status = 'Upcoming';
            if (paidInstallments.has(installmentId)) {
                status = 'Paid';
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isBefore"])(dueDate, today)) {
                status = 'Overdue';
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["differenceInDays"])(dueDate, today) <= 30) {
                status = 'Due Soon';
            }
            dueItems.push({
                id: installmentId,
...
async function getSummary(duePayments) {
    const summary = {
        totalReceivable: 0,
        totalPayable: 0,
        overdueReceivable: 0,
...
async function deleteDuePaymentInstallment(installmentId) {
    try {
        ...
        if (leaseIndex > -1) {
            leaseContracts[leaseIndex].paymentSchedule = leaseContracts[leaseIndex].paymentSchedule.filter((inst)=>inst.installment.toString() !== installmentNo);
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(leaseContractsFilePath, JSON.stringify(leaseContracts, null, 2), 'utf-8');
            contractFound = true;
        }
        const tenancyIndex = tenancyContracts.findIndex((c)=>c.contractNo === contractNo);
        if (tenancyIndex > -1) {
            tenancyContracts[tenancyIndex].paymentSchedule = tenancyContracts[tenancyIndex].paymentSchedule.filter((inst)=>inst.installment.toString() !== installmentNo);
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(tenancyContractsFilePath, JSON.stringify(tenancyContracts, null, 2), 'utf-8');
            contractFound = true;
        }
        if (!contractFound) {
            return {
                success: false,
                error: 'Could not find the source contract for this due payment.'
            };
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/finance/due-payments');
        return {
            success: true
        };
    } catch (error) {
        return {
            success: false,
            error: 'Failed to delete due payment entry.'
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getDuePayments, "00f5bec3b7d6871d6a6a74ef3c1a0c9d5c344fcfe9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getSummary, "40b728a3e12571d9a7517418be6c007897bec6720e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteDuePaymentInstallment, "400a999ba599a0f01e1fe8829d5603350d5f9ce9a9", null);
}),
...
"[project]/.next-internal/server/app/finance/due-payments/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/finance/due-payments/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/src/app/finance/payment/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/src/app/lookups/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/src/app/tenancy/customer/invoice/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/finance/due-payments/actions.ts [app-rsc] (ecmascript)");
...
__turbopack_context__.s([
    ...
    "00f5bec3b7d6871d6a6a74ef3c1a0c9d5c344fcfe9",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDuePayments"],
    "400a999ba599a0f01e1fe8829d5603350d5f9ce9a9",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteDuePaymentInstallment"],
    ...
    "40b728a3e12571d9a7517418be6c007897bec6720e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSummary"],
...
"[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const DuePaymentsClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call DuePaymentsClient() from the server but DuePaymentsClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/finance/due-payments/due-payments-client.tsx <module evaluation>", "DuePaymentsClient");
}),
"[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const DuePaymentsClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call DuePaymentsClient() from the server but DuePaymentsClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/finance/due-payments/due-payments-client.tsx", "DuePaymentsClient");
}),
"[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$due$2d$payments$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$due$2d$payments$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$due$2d$payments$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/app/finance/due-payments/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/finance/due-payments/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$due$2d$payments$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/finance/due-payments/due-payments-client.tsx [app-rsc] (ecmascript)");
;
;
;
async function DuePaymentsPage() {
    const duePayments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDuePayments"])();
    const summary = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSummary"])(duePayments);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$due$2d$payments$2f$due$2d$payments$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DuePaymentsClient"], {
        initialPayments: duePayments,
        initialSummary: summary
    }, void 0, false, {
        fileName: "[project]/src/app/finance/due-payments/page.tsx",
        lineNumber: 11,
        columnNumber: 5
    }, this);
}
}),
"[project]/src/app/finance/due-payments/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/finance/due-payments/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eade6549._.js.map