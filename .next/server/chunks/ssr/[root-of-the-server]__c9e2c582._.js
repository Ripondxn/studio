...
"[project]/src/app/vendors/agents/schema.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v3/external.js [app-rsc] (ecmascript) <export * as z>");
;
const agentSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    commissionRate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    totalCommissionPaid: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    vendorCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    vendorName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional()
});
}),
"[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"001ddc81c529c150e67435f86cd7f4cbf36932472a":"getAllAgents","402605caac262857bd5aa709b54b12917f144fb63e":"findAgentData","4088294176821618dd673e2c68e03bc0d9b156d0dd":"getPaymentsForAgent","40af4ded281154f613b60d90e295c58f332de48edc":"deleteAgent","60fbb1b49909fec473debd2b8f9469080e108dc655":"saveAgentData"},"",""] */ __turbopack_context__.s([
    "deleteAgent",
    ()=>deleteAgent,
    "findAgentData",
    ()=>findAgentData,
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/cache.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$schema$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/schema.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
...
async function readAgents() {
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(agentsFilePath);
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(agentsFilePath, 'utf-8');
        return JSON.parse(data);
    } catch (error) {
        if (error.code === 'ENOENT') {
            await writeAgents([]);
...
async function writeAgents(data) {
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(agentsFilePath, JSON.stringify(data, null, 2), 'utf-8');
}
...
async function getVendors() {
    try {
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(vendorsFilePath, 'utf-8');
        // The vendors data is nested, so we extract it.
        return JSON.parse(data).map((v)=>v.vendorData);
    } catch (error) {
        if (error.code === 'ENOENT') {
            return [];
        }
...
async function getAllAgents() {
    ...
    const commissionPaidMap = new Map();
    payments.forEach((p)=>{
...
async function getPaymentsForAgent(agentCode) {
    const allPayments = await getPayments();
    const agentPayments = allPayments.filter((p)=>p.agentCode === agentCode && p.type === 'Payment');
    return agentPayments.sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime());
}
async function findAgentData(agentCode) {
    try {
        ...
        const agent = allAgents.find((a)=>a.code === agentCode);
        if (agent) {
            return {
                success: true,
                data: agent
...
async function saveAgentData(data, isNewRecord) {
    try {
        const allAgents = await readAgents();
        let savedData;
        if (isNewRecord) {
            ...
            const validation = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$schema$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["agentSchema"].safeParse(newAgentWithId);
            if (!validation.success) {
                return {
                    success: false,
            ...
            const validation = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$schema$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["agentSchema"].safeParse(data);
            if (!validation.success) {
                return {
                    success: false,
                    error: validation.error.errors.map((e)=>e.message).join(', ')
...
async function deleteAgent(agentCode) {
    ...
    try {
        const allAgents = await readAgents();
        const updatedAgents = allAgents.filter((a)=>a.code !== agentCode);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getAllAgents, "001ddc81c529c150e67435f86cd7f4cbf36932472a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPaymentsForAgent, "4088294176821618dd673e2c68e03bc0d9b156d0dd", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(findAgentData, "402605caac262857bd5aa709b54b12917f144fb63e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveAgentData, "60fbb1b49909fec473debd2b8f9469080e108dc655", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteAgent, "40af4ded281154f613b60d90e295c58f332de48edc", null);
}),
...
"[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"006ce5f7b2a02de3d5935502ee6323868e86fa637f":"getExpenseAccounts","00b385d826c1253f234c1b53e4e3d7e5f331da2752":"getRevenueAccounts"},"",""] */ __turbopack_context__.s([
    "getExpenseAccounts",
    ()=>getExpenseAccounts,
    "getRevenueAccounts",
    ()=>getRevenueAccounts
...
async function getExpenseAccounts() {
    const accounts = await readData(accountsFilePath);
    return accounts.filter((acc)=>acc.type === 'Expense' && !acc.isGroup).map((acc)=>({
            value: acc.code,
            label: `${acc.name} (${acc.code})`
        }));
...
async function getRevenueAccounts() {
    const accounts = await readData(accountsFilePath);
    return accounts.filter((acc)=>acc.type === 'Revenue' && !acc.isGroup).map((acc)=>({
            value: acc.code,
            label: `${acc.name} (${acc.code})`
        }));
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getExpenseAccounts, "006ce5f7b2a02de3d5935502ee6323868e86fa637f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getRevenueAccounts, "00b385d826c1253f234c1b53e4e3d7e5f331da2752", null);
}),
...
"[project]/src/app/vendors/bill/schema-def.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v3/external.js [app-rsc] (ecmascript) <export * as z>");
;
const billItemSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Description is required.'),
    quantity: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1, 'Quantity must be at least 1.'),
    unitPrice: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(0, 'Unit price must be positive.'),
    total: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number(),
    expenseAccountId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Expense account is required.")
});
const billSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
    billNo: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Bill number is required.'),
    vendorCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Vendor is required.'),
    vendorName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Vendor name is required.'),
    property: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    unitCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    roomCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    maintenanceTicketId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    utilityAccountId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    billDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Bill date is required.'),
    dueDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Due date is required.'),
    vatRegNo: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    items: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(billItemSchema).min(1, 'At least one item is required.'),
    subTotal: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number(),
    taxType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'exclusive',
        'inclusive'
...
"[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00ec49ade21a3c606b0146abaa416d0c3b5b6adad9":"getNextBillNumber","4035145f87829a953b638c03a8136422cee90c3af9":"getBillsForVendor","4079421f27e6453c296b17bc15014bd55afe91096f":"deleteBill","4085685bed4c067c72741e1eb1c16a16ba589cd7d5":"saveBill"},"",""] */ __turbopack_context__.s([
    "deleteBill",
    ()=>deleteBill,
    "getBillsForVendor",
    ()=>getBillsForVendor,
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/cache.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$bill$2f$schema$2d$def$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/bill/schema-def.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
...
async function readBills() {
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(billsFilePath);
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(billsFilePath, 'utf-8');
        return JSON.parse(data);
    } catch (error) {
        if (error.code === 'ENOENT') {
            await writeBills([]);
...
async function getBillsForVendor(vendorCode) {
    const allBills = await readBills();
...
async function saveBill(data) {
    ...
    const validation = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$bill$2f$schema$2d$def$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["billSchema"].omit({
        id: true,
        amountPaid: true,
        remainingBalance: true
    }).safeParse(dataWithDueDate);
    if (!validation.success) {
    ...
    try {
        ...
        if (data.id) {
            ...
            if (isAutoBillNo || !newBillNo) {
                ...
                if (billExists) {
                    return {
                        success: false,
                        error: `A bill with number "${newBillNo}" already exists.`
                    };
                }
            }
            const newBill = {
        ...
        await writeBills(allBills);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/vendors/add?code=${data.vendorCode}`);
        return {
            success: true,
            data: savedBill
        };
...
async function deleteBill(billId) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/vendors/add?code=${billToDelete.vendorCode}`);
        return {
            success: true
        };
    } catch (error) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getBillsForVendor, "4035145f87829a953b638c03a8136422cee90c3af9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getNextBillNumber, "00ec49ade21a3c606b0146abaa416d0c3b5b6adad9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveBill, "4085685bed4c067c72741e1eb1c16a16ba589cd7d5", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteBill, "4079421f27e6453c296b17bc15014bd55afe91096f", null);
}),
"[project]/.next-internal/server/app/vendors/agents/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/src/app/finance/payment/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/src/app/lookups/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/src/app/tenancy/customer/invoice/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$chart$2d$of$2d$accounts$2f$lookups$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$invoice$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tenancy/customer/invoice/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$bill$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/vendors/agents/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/license.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/src/app/finance/payment/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/src/app/lookups/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/src/app/tenancy/customer/invoice/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "001ddc81c529c150e67435f86cd7f4cbf36932472a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllAgents"],
    ...
    "006ce5f7b2a02de3d5935502ee6323868e86fa637f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$chart$2d$of$2d$accounts$2f$lookups$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getExpenseAccounts"],
    ...
    "402605caac262857bd5aa709b54b12917f144fb63e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findAgentData"],
    "4035145f87829a953b638c03a8136422cee90c3af9",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$bill$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBillsForVendor"],
    "4088294176821618dd673e2c68e03bc0d9b156d0dd",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPaymentsForAgent"],
    "40af4ded281154f613b60d90e295c58f332de48edc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteAgent"],
    "40b851d950a24cfbdf727f9a603d2d4afdfea189f2",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$invoice$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getInvoicesForCustomer"],
    "40bf7b83aadd69dd72d817b755f99ee278568979fd",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$payment$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deletePayment"],
    ...
    "40f63833d5b57077b24cc2382f8d23e4cdb16edf29",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$payment$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addPayment"],
    ...
    "60fbb1b49909fec473debd2b8f9469080e108dc655",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveAgentData"],
    "7ca7e9feb76f697a6346d34a2f43785d84a5fab496",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$finance$2f$payment$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getReferences"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$vendors$2f$agents$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE5__$3d3e$__$225b$project$5d2f$src$2f$app$2f$finance$2f$payment$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE6__$3d3e$__$225b$project$5d2f$src$2f$app$2f$lookups$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE7__$3d3e$__$225b$project$5d2f$src$2f$app$2f$finance$2f$chart$2d$of$2d$accounts$2f$lookups$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE8__$3d3e$__$225b$project$5d2f$src$2f$app$2f$tenancy$2f$contract$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE9__$3d3e$__$225b$project$5d2f$src$2f$app$2f$tenancy$2f$customer$2f$invoice$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE10__$3d3e$__$225b$project$5d2f$src$2f$app$2f$vendors$2f$bill$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/vendors/agents/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/lib/license.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE5 => "[project]/src/app/finance/payment/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE6 => "[project]/src/app/lookups/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE7 => "[project]/src/app/finance/chart-of-accounts/lookups.ts [app-rsc] (ecmascript)", ACTIONS_MODULE8 => "[project]/src/app/tenancy/contract/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE9 => "[project]/src/app/tenancy/customer/invoice/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE10 => "[project]/src/app/vendors/bill/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$company$2d$profile$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/company-profile/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$license$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/license.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$currency$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/currency/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$access$2d$control$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/access-control/actions.ts [app-rsc] (ecmascript)");
...
"[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const AgentContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call AgentContent() from the server but AgentContent is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/vendors/agents/agent-content.tsx <module evaluation>", "AgentContent");
}),
"[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const AgentContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call AgentContent() from the server but AgentContent is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/vendors/agents/agent-content.tsx", "AgentContent");
}),
"[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$agent$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$agent$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$agent$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/app/vendors/agents/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$agent$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/vendors/agents/agent-content.tsx [app-rsc] (ecmascript)");
;
;
;
;
...
async function AgentsPage() {
    const agents = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllAgents"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                fileName: "[project]/src/app/vendors/agents/page.tsx",
                                lineNumber: 17,
                                columnNumber: 13
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-muted-foreground",
                                children: "A list of all commission-based agents."
                            }, void 0, false, {
                                fileName: "[project]/src/app/vendors/agents/page.tsx",
                                lineNumber: 18,
                                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$vendors$2f$agents$2f$agent$2d$content$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AgentContent"], {
                agents: agents
            }, void 0, false, {
                fileName: "[project]/src/app/vendors/agents/page.tsx",
                lineNumber: 26,
...
"[project]/src/app/vendors/agents/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/vendors/agents/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c9e2c582._.js.map